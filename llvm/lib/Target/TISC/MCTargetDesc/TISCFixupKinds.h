//===-- TISCFixupKinds.h - TISC Specific Fixup Entries ------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_TISC_MCTARGETDESC_TISCFIXUPKINDS_H
#define LLVM_LIB_TARGET_TISC_MCTARGETDESC_TISCFIXUPKINDS_H
...
// MCFixupKindInfo Infos[TISC::NumTargetFixupKinds]
// in TISCAsmBackend.cpp.
//
enum Fixups {
